        ...
        <div className='flex-1 overflow-x-auto mx-5 mt-8'>
            ...
            <div className={`${theme == "dark" ? "bg-[#1D1D1F]" : "border"} mt-5 p-5 rounded-md`}>
                ...
                <div className="w-[100%]">
                    {
                        [1, 23, 4, 5]?.map((i) => (
                            <div key={i} className={`cursor-pointer ${theme == "dark" ? "text-[#C9C9C9]" : "text-black"} flex justify-between items-center flex-wrap rounded-[1rem] py-2 px-3 my-3 ${theme == "dark" ? "bg-[#202022]" : "border"}`}>
                                <div className="flex items-center flex-wrap">
                                    <img src={CoverImage} alt="" />
                                    <div className="ml-3">
                                        <p className={`${theme == "dark" ? "text-white" : "text-black"} font-medium text-sm`}>Username</p>
                                        <p className={`${theme == "dark" ? "text-[#828287]" : "text-black"} text-xs mt-1`}>Artist/podcaster</p>
                                    </div>
                                </div>
                                <div className="ml-3">
                                    <p className={`${theme == "dark" ? "text-[#828287]" : "text-black"} text-xs mt-1`}>20,226,206</p>
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className={`${theme == "dark" ? "text-[#828287]" : "text-black"} text-xs mt-1`}>20</p>
                                </div>
                                <div className="ml-3">
                                    <p className={`${theme == "dark" ? "text-white" : "text-black"} font-medium text-sm`}>Last Upload</p>
                                    <p className={`${theme == "dark" ? "text-[#828287]" : "text-black"} text-xs mt-1`}>2 weeks ago</p>
                                </div>
                                <button className={`${theme == "dark" ? "text-[#fff]" : "text-black"} ${theme == "dark" ? "bg-[#303332]" : "border"} text-xs px-3 py-1 rounded-md `}>22,2,3300</button>
